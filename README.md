...
| total_paid                    | float  | The total amount paid for the expenses of drug exposure. This field should not contain an imputed value. Only populate this field if the raw data provides a clear source of information on how much was paid, in total, for this service/exposure. |
